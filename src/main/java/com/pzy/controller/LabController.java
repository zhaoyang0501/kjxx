...
public class LabController {
	...
	public String create(Model model) {
		model.addAttribute("categorys",categoryService.findByType("50"));
		return "admin/lab/create";
	}
	@RequestMapping("index")
	public String index() {
		return "admin/lab/index";
	}
	
	@RequestMapping(value = "/create", method = RequestMethod.POST)
	public String save(Lab lab,Model model) {
	...
	public Map<String, Object> list(
		...
		Page<Lab> users = labService.findAll(pageNumber, pageSize, name);
