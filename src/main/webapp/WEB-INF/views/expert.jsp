              ...
              <div class="envor-widget-inner">
                <ul>
	                <c:forEach var="bean" items="${cagegorys }">
	                	 <li>
	                   	 	<p><a href="expert?cid=${bean.id }"><i class="glyphicon glyphicon-folder-open"></i>${bean.name }</a> <a ><i class="fa fa-rss"></i></a></p>
           		...
           		<div class="col-lg-9">
           			...
           			<table class="table table-bordered">
						...
						<tbody>
						<c:forEach items="${experts }" var="bean">
						<tr>
									<th><a href="viewexpert?id=${bean.id }">${bean.title }</a> <img src="http://www.bjsxt.com/statics/images/bjsxt/kb_new.gif" style="opacity: 1;"></th>
