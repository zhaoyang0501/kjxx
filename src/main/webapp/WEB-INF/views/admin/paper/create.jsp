				...
				<div class="row-fluid ">
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<form action="${pageContext.request.contextPath}/admin/paper/create" method="post" id=''>
							<div class="control-group">
								<label for="title" class="control-label">论文简介：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">论文分类：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">论文详细：</label>
								<div class="controls">
