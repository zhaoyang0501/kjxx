          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="envor-desktop-breadscrubs-inner">
                <a href="index.html">首页</a><i class="fa fa-angle-double-right"></i>专利文献
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="envor-widget-inner">
                <ul>
	                <c:forEach var="bean" items="${cagegorys }">
	                	 <li>
	                   	 	<p><a href="patent?cid=${bean.id }"><i class="glyphicon glyphicon-folder-open"></i>${bean.name }</a> <a ><i class="fa fa-rss"></i></a></p>
           		...
           		<div class="col-lg-9">
	           		...
	           		<form action="patent" method="post">
           			...
           			<table class="table table-bordered">
						...
						<tbody>
						<c:forEach items="${patents }" var="bean">
						<tr>
									<th><a href="viewpatent?id=${bean.id }">${bean.title }</a> <img src="http://www.bjsxt.com/statics/images/bjsxt/kb_new.gif" style="opacity: 1;"></th>
