				...
				<div class="row-fluid ">
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<form action="${pageContext.request.contextPath}/admin/lab/create" method="post" id=''>
							<div class="control-group">
								<label for="title" class="control-label">设备名称：</label>
								<div class="controls">
									<input type="text" name="title" placeholder="">
								</div>
							</div>
							<div class="control-group">
								<label for="title" class="control-label">负责人：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">所在单位：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">存放地点：</label>
								<div class="controls">
									<input type="text" name="cfdd" placeholder="">
								</div>
							</div>
							
							<div class="control-group">
								<label for="title" class="control-label">设备编号：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">设备分类：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">专利文献详情：</label>
								<div class="controls">
