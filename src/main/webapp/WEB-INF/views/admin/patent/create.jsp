				...
				<div class="row-fluid ">
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<form action="${pageContext.request.contextPath}/admin/patent/create" method="post" id=''>
							<div class="control-group">
								<label for="title" class="control-label">文献简介：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">专利分类：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">申请号：</label>
								<div class="controls">
									<input type="text" name="sqh" placeholder="">
								</div>
							</div>
							
							<div class="control-group">
								<label for="title" class="control-label">公开号：</label>
								<div class="controls">
									<input type="text" name="gkh" placeholder="">
								</div>
							</div>
							<div class="control-group">
