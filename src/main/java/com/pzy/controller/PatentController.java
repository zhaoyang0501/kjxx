...
public class PatentController {
	...
	public String create(Model model) {
		model.addAttribute("categorys",categoryService.findByType("40"));
		return "admin/patent/create";
	}
	@RequestMapping("index")
	public String index() {
		return "admin/patent/index";
	}
	
	@RequestMapping(value = "/create", method = RequestMethod.POST)
	public String save(Patent patent,Model model) {
	...
	public Map<String, Object> list(
		...
		Page<Patent> users = patentService.findAll(pageNumber, pageSize, name);
